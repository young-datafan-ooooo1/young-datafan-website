...
| percentage_num | 百分比转数字 | Y     | Y      | Y          | Y          | Y   | Y         |
| num_percentage | 数字转百分比 | Y     | Y      | Y          | Y          | Y   | Y         |
...
| mul_polym  | 乘积         | Y     | Y      | Y          | Y          | Y   | Y         |
| quantile  | Pth百分位         | N     | Y      | Y          | Y          | Y   | N         |
| standard_error  | 标准误差         | Y     | Y      | Y          | Y          | Y   | Y         |
| stddev_pop  | 总体标准差         | Y     | Y      | Y          | Y          | Y   | Y         |
| var_pop  | 总体方差         | Y     | Y      | Y          | Y          | Y   | Y         |
| covar_pop  | 协方差         | Y     | Y      | Y          | Y          | Y   | Y         |
| correlation_coefficient  | 相关系数         | Y     | Y      | Y          | Y          | Y   | Y         |
| sum_squares  | 平方和         | Y     | Y      | Y          | Y          | Y   | Y         |
| sum_weight  | 权重和         | Y     | Y      | Y          | Y          | Y   | Y         |