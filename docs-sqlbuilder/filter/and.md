...
public class Test {
    ...
    public void getFunction() {
        ...
        where.and(BinaryCondition.equal(age, equal));
        where.and( BinaryCondition.greaterThanOrEqual(age, equal));
...
````sql
SELECT t."name" AS "name",t."age" AS "age" FROM "test" t WHERE t."age" = 2 AND t."age" >= 2       
````
