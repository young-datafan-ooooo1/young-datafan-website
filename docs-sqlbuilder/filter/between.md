...
public class Test {
    ...
    public void getFunction() {
        ...
        query.addFrom(test);
        CustomSql equal = CustomSql.getCustomSql("10");
        CustomSql equal1 = CustomSql.getCustomSql("20");
        //where
        Conditions where = Conditions.getInstance(Cp.NONE, BetweenCondition.between(age, equal, equal1));
...
````sql
SELECT t."name" AS "name",t."age" AS "age" FROM "test" t WHERE t."age" BETWEEN 10 AND 20     
````
