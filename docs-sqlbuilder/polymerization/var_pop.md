...
public class Test {
    ...
    public void function() {
        ...
        Function function = Function.getFunction(FunctionType.VAR_POP, age);
...
````sql
SELECT VAR_POP(t."age") FROM "test" t     
````
...
### CLICKHOUSE
````sql
SELECT varPop(t.age) FROM test t     
````
