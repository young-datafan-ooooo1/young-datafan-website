...
public class Test {
    ...
    public void getFunction() {
        ...
        CustomSql customSql = CustomSql.getCustomSql("2");
        Function function = Function.getFunction(FunctionType.TO_DECIMAL, num, customSql);
...
````sql
SELECT CAST(t.num AS DECIMAL(38,2)) AS val FROM test t 
````